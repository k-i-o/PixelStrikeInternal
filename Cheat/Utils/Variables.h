...
namespace Variables {
	...
	inline bool ShowHealth = false;

	inline bool EnableBoxes = false;
	inline bool EnableRainbowBoxes = false;
	inline ImColor BoxesColor = ImColor(255.0f / 255, 255.0f / 255, 255.0f / 255);
}